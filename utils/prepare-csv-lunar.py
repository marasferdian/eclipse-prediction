...
from helper_functions import get_minimum_separation_lunar
import pandas as pd

df = pd.read_csv('../numerical_methods/lunar-eclipses.csv', parse_dates=['Date'])
df = df.tail(500)
eclipses_list = df['Date'].tolist()

with open('../ML/lunar-eclipses-classif.csv', mode='w') as csv_file:
